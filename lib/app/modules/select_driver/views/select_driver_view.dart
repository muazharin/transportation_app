...
class SelectDriverView extends GetView<SelectDriverController> {
  const SelectDriverView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: customAppBar(title: "Pilih Pengemudi"),
            ...
            child: Column(
              ...
              children: [
                ...
                InputText(
                  ...
                  validator: (v) => valString!(v, "Cari Pengemudi"),
                  onChanged: (v) => controller.onSearch(v: v),
                ),
                const SizedBox(height: 24),
                GetBuilder<SelectDriverController>(builder: (context) {
