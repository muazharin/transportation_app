...
import 'package:latransportindo/app/modules/customers/views/card_list.dart';
import 'package:latransportindo/app/routes/app_pages.dart';

class ListDataView extends GetView<CustomersController> {
        ...
        children: [
          Column(
            children: [
              ...
              GetBuilder<CustomersController>(builder: (context) {
                return Row(
                  children: [
                    Expanded(
                      child: InputText(
              ...
              Expanded(
                child: GetBuilder<CustomersController>(builder: (context) {
