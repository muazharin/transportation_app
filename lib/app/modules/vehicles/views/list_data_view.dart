...
import 'package:latransportindo/app/modules/vehicles/views/card_list.dart';
import 'package:latransportindo/app/routes/app_pages.dart';

class ListDataView extends GetView<VehiclesController> {
        ...
        children: [
          Column(
            children: [
              ...
              GetBuilder<VehiclesController>(builder: (context) {
                return Row(
                  children: [
                    Expanded(
                      child: InputText(
              ...
              Expanded(
                child: GetBuilder<VehiclesController>(builder: (context) {
